...
var accordion = __webpack_require__(/*! ./parts/accordion.js */ "./src/parts/accordion.js"),
    addStyles = __webpack_require__(/*! ./parts/addStyles.js */ "./src/parts/addStyles.js"),
    ajax = __webpack_require__(/*! ./parts/ajax.js */ "./src/parts/ajax.js"),
    calculator = __webpack_require__(/*! ./parts/calculator.js */ "./src/parts/calculator.js"),
    filtr = __webpack_require__(/*! ./parts/filtr.js */ "./src/parts/filtr.js"),
    firstModal = __webpack_require__(/*! ./parts/firstModal.js */ "./src/parts/firstModal.js"),
    hamburger = __webpack_require__(/*! ./parts/hamburger.js */ "./src/parts/hamburger.js"),
    HoverEffect = __webpack_require__(/*! ./parts/HoverEffect.js */ "./src/parts/HoverEffect.js"),
    mainSlider = __webpack_require__(/*! ./parts/mainSlider.js */ "./src/parts/mainSlider.js"),
    secondModal = __webpack_require__(/*! ./parts/secondModal.js */ "./src/parts/secondModal.js"),
    secondSlider = __webpack_require__(/*! ./parts/secondSlider.js */ "./src/parts/secondSlider.js"),
    thirtModal = __webpack_require__(/*! ./parts/thirtModal.js */ "./src/parts/thirtModal.js");
  ...
  if (window.innerWidth > 900) {
    for (var i = 0; i < sizesBlock.length; i++) {
      sizesBlock[i].addEventListener("mouseover", function () {
        ...
        if (picture.classList.contains("size-1")) picture.src = "./img/sizes-1-1.png";
        if (picture.classList.contains("size-2")) picture.src = "./img/sizes-2-1.png";
        if (picture.classList.contains("size-3")) picture.src = "./img/sizes-3-1.png";
        if (picture.classList.contains("size-4")) picture.src = "./img/sizes-4-1.png";
      ...
      sizesBlock[i].addEventListener("mouseout", function () {
        var picture = this.querySelector("img");
        if (picture.classList.contains("size-1")) picture.src = "./img/sizes-1.png";
        if (picture.classList.contains("size-2")) picture.src = "./img/sizes-2.png";
        if (picture.classList.contains("size-3")) picture.src = "./img/sizes-3.png";
        if (picture.classList.contains("size-4")) picture.src = "./img/sizes-4.png";
    ...
    ///для мобилы
    for (var _i = 0; _i < sizesBlock.length; _i++) {
      sizesBlock[_i].addEventListener("click", function () {
        var picture = this.querySelector("img");
        if (picture.classList.contains("size-1")) picture.src = "./img/sizes-1-1.png";
        if (picture.classList.contains("size-2")) picture.src = "./img/sizes-2-1.png";
        if (picture.classList.contains("size-3")) picture.src = "./img/sizes-3-1.png";
    ...
    document.body.addEventListener("click", function (e) {
      for (var _i2 = 0; _i2 < sizesBlock.length; _i2++) {
        if (e.target.closest("." + sizesBlock[_i2].classList) != null) {
          // console.log(e.target.parentNode.querySelector("img").classList.value);
          if (e.target.parentNode != sizesBlock[_i2]) {
            // console.log(sizesBlock[i].querySelector("img").classList.value);
            setPicture(sizesBlock[_i2]);
          }
        } else setPicture(sizesBlock[_i2]);
      }

      function setPicture(item) {
        if (item.querySelector("img").classList.value == "size-1") item.querySelector("img").src = "./img/sizes-1.png";
        if (item.querySelector("img").classList.value == "size-2") item.querySelector("img").src = "./img/sizes-2.png";
        if (item.querySelector("img").classList.value == "size-3") item.querySelector("img").src = "./img/sizes-3.png";
        if (item.querySelector("img").classList.value == "size-4") item.querySelector("img").src = "./img/sizes-4.png";
...
function accordion() {
    ...
    accordionHeading[i].addEventListener('click', function () {
      ...
      if (accordionHeading[i].id == "accHead-1") {
        if (document.getElementById("accBody-1").style.display == "none") {
          hideAll();
          accAnimate(document.getElementById("accBody-1")); //          document.getElementById("accBody-1").style.display = "block";
  ...
  function accAnimate(element) {
    ...
    var Anim = function Anim() {
      if (+element.style.opacity != 1) element.style.opacity = +element.style.opacity + 0.1 + "";else clearInterval(z);
    };

    var z = setInterval(Anim, 50);
  }
}
...
function addStyles() {
  var addStyles = document.getElementsByClassName("button-styles")[0],
      hiddenStyles = document.getElementsByClassName("styles-2");
  addStyles.addEventListener('click', function () {
        ...
        return new _Promise(function (resolve, reject) {
          ...
          requesst.addEventListener('readystatechange', function () {
            if (requesst.readyState < 4) {
              ...
              statusMesaage.style.height = "80px"; //    statusMesaage.style.background = `url(${message.success}) no-repeat center`;

              statusMesaage.style.marginTop = "10px"; //  document.getElementById("modalPhone").value = "";

              clean(form[i]);
            } else {
              statusMesaage.innerHTML = message.failure;
              statusMesaage.style.height = "80px"; //  statusMesaage.style.background = `url(${message.failure}) no-repeat center`;
...
function calculator() {
  var pictureSize = document.getElementById("size"),
  ...
  function toCount(promo) {
    var a;
    if (options.value == "Дополнительные услуги") a = 0;else a = mapping[options.value];
  ...
  ;
  pictureSize.addEventListener('change', function () {
    if (pictureSize.value != "Выберите размер картины" && pictureMaterial.value != "Выберите материал картины") {
      // console.log("Hi");
      if (promocod.value == "IWANTPOPART") calcPrice.textContent = toCount(true);else {
  ...
  pictureMaterial.addEventListener('change', function () {
    if (pictureSize.value != "Выберите размер картины" && pictureMaterial.value != "Выберите материал картины") {
      if (promocod.value == "IWANTPOPART") calcPrice.textContent = toCount(true);else calcPrice.textContent = toCount(false);
    } else calcPrice.textContent = "Для расчета нужно выбрать размер картины и материал картины";
  });
  ...
  promocod.addEventListener('change', function () {
    if (pictureSize.value != "Выберите размер картины" && pictureMaterial.value != "Выберите материал картины") {
      if (promocod.value == "IWANTPOPART") calcPrice.textContent = toCount(true);else calcPrice.textContent = toCount(false);
    } else calcPrice.textContent = "Для расчета нужно выбрать размер картины и материал картины";
  });
...
function filtr() {
  var portfolioMenu = document.querySelectorAll(".portfolio-menu li"),
  ...
  for (var i = 0; i < portfolioMenu.length; i++) {
    portfolioMenu[i].addEventListener('click', function (e) {
      ...
      for (var j = 0; j < portfolioMenu.length; j++) {
...
function firstModal() {
  var reqPopupDesign = document.getElementsByClassName("reqPopupDesign"),
  ...
  for (var i = 0; i < reqPopupDesign.length; i++) {
    ...
    reqPopupDesign[i].addEventListener('click', function () {
  ...
  document.body.addEventListener('click', function (e) {
    ...
    if (e.target.closest(".popup-content") == null && e.target != reqPopupDesign[0] && e.target != reqPopupDesign[1] && e.target != reqPopupDesign[2] && e.target != reqPopupDesign[3] && e.target != reqPopupDesign[4] && e.target != reqPopupDesign[5] && e.target != reqPopupDesign[6]) PopupDesign.style.display = "none";
  });
}
...
function hamburger() {
  function burgerMenu() {
    if (bm.style.display != "block") bm.style.display = "block";else bm.style.display = "none";
  }
  ...
  window.addEventListener('resize', function () {
    if (bm.style.display == "block" && window.innerWidth > 768) bm.style.display = "none";
  });
}
...
function mainSlider() {
  ...
  function showSlides(n) {
    ...
    var hight = slides[slideIndex - 1].clientHeight; // console.log(hight);

    slides[slideIndex - 1].style.marginTop = "-" + hight + "px";

    var sliderAnimation = function sliderAnimation() {
      var mt = +slides[slideIndex - 1].style.marginTop.replace('px', "");
      if (mt < -15) slides[slideIndex - 1].style.marginTop = mt + hight / 34 + "px";else clearInterval(z);
    };

    var z = setInterval(sliderAnimation, 20);
  }
...
function secondModal() {
  var reqPopupConsultation = document.getElementsByClassName("reqPopupConsultation"),
      PopupConsultation = document.getElementsByClassName("popup-consultation")[0];
  ...
  secondPopupClose.addEventListener('click', function () {
    PopupConsultation.style.display = "none";
  });
  document.body.addEventListener('click', function (e) {
    if (e.target.closest(".popup-content") == null && e.target != reqPopupConsultation[0] && e.target != reqPopupConsultation[1] && e.target != reqPopupConsultation[2]) PopupConsultation.style.display = "none";
  });
...
function secondSlider() {
  ...
  function animate(element) {
    element.style.display = "block";
    element.style.width = "900px"; // element.style.border = "2px solid";

    element.style.marginLeft = "-1100px";

    var sliderAnimation = function sliderAnimation() {
      var mt = +element.style.marginLeft.replace('px', "");
      if (mt < -15) element.style.marginLeft = mt + 600 / 34 + "px";else clearInterval(z);
    };
...
function thirtModal() {
  var reqPopupGift = document.getElementsByClassName("reqPopupGift")[0],
      PopupGift = document.getElementsByClassName("popup-gift")[0];
  thirdPopupClose = document.querySelector(".popup-gift .popup-close");
  reqPopupGift.addEventListener('click', function () {
    PopupGift.style.display = "block";
    reqPopupGift.style.display = "none";
  });
  thirdPopupClose.addEventListener('click', function () {
  ...
  document.body.addEventListener('click', function (e) {
    if (e.target.closest(".popup-content") == null && e.target != reqPopupGift) PopupGift.style.display = "none";
  });
}
